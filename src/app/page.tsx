...
export default function Home() {
  ...
  const onSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setResult(null)
      setError('Error: Invalid MD5 hash')
    }
  }
      ...
      <div className="container max-w-md px-4 py-12 space-y-6">
        ...
        >
          <Input
            ...
            className="flex-1 px-4 py-2 text-primary border-2 border-primary rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            value={md5}
